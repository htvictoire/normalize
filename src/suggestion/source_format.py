...
def infer_source_format(
    file_path: Path,
    *,
    sample_bytes: int = FILE_SAMPLE_BYTES,
) -> SourceFormatConfig:
    """Infer all SourceFormatConfig fields from the first sample_bytes of the file."""
    return infer_source_format_from_bytes(file_path.read_bytes()[:sample_bytes])
